...
abstract class Eauth_Acl_Driver extends \Eauth_Driver
{
	/**
	...
	public static function forge(array $config = array())
	{
		...
		$class = \Inflector::get_namespace($config['driver']).'Eauth_Acl_'.\Str::ucwords(\Inflector::denamespace($config['driver']));
