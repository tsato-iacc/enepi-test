...
<div class="form-group">
  <div class="btn-group" role="group" aria-label="...">
    ...
    <% end %>
    <%= link_to "変更履歴をCSVでダウンロード", url_for(params.merge(controller: "admin/lpgas/estimates/change_logs", format: :csv)), class: 'btn btn-default' %>
  </div>
</div>
  ...
  <tbody>
    <% @estimates.each do |e| %>
      <tr>
        ...
        <td>
          <ul>
            <li><%= link_to '詳細', admin_lpgas_estimate_path(e) %></li>
