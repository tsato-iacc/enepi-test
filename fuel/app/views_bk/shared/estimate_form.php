<div class="register-form" id="register_form">
  ...
  <div class="mainform-topimg">
    <% if smart_phone? %>
      <%= image_tag asset_url("estimate_form/sp/title.png") %>
    <% else %>
      <%= image_tag asset_url("estimate_form/title.png") %>
    <% end %>    
  </div>
  ...
  <div class="form-wrap">
    <%= form_for @lpgas_contact, url: @form_url, method: 'POST' do |f| %>
      ...
      <div class="form-step<% if smart_phone? %> form-align<% end %>">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="slide-content slide-content-1">
              ...
              <div class="content-box sep-two step-hand-navi">
                <div class="hand-navi-wrap<%= ' opacity-0' if @lpgas_contact.house_kind.present? %>">
                  <div><%= image_tag asset_url("estimate_form/hand-navi.png") %></div>
                  <div><%= image_tag asset_url("estimate_form/hand-navi.png") %></div>
                  <div><%= image_tag asset_url("estimate_form/hand-navi.png") %></div>
                </div>
                <div class="house-kind input-wrap remove-error">
                  ...
                  <label class="image-wrap hand-navi-label" for="detached">
                    <div class="normal sp"><%= image_tag asset_url("estimate_form/sp/off-btn-home.png") %></div>
                    <div class="invert sp"><%= image_tag asset_url("estimate_form/sp/on-btn-home.png") %></div>
                    <div class="normal pc"><%= image_tag asset_url("estimate_form/off-btn-home.png") %></div>
                    <div class="invert pc"><%= image_tag asset_url("estimate_form/on-btn-home.png") %></div>
                    <p>戸建・持ち家</p>
                  </label>
                </div>
                <div class="house-kind input-wrap remove-error">
                  ...
                  <label class="image-wrap hand-navi-label" for="store_ex">
                    <div class="normal sp"><%= image_tag asset_url("estimate_form/sp/off-btn-store.png") %></div>
                    <div class="invert sp"><%= image_tag asset_url("estimate_form/sp/on-btn-store.png") %></div>
                    <div class="normal pc"><%= image_tag asset_url("estimate_form/off-btn-store.png") %></div>
                    <div class="invert pc"><%= image_tag asset_url("estimate_form/on-btn-store.png") %></div>
                    <p>店舗</p>
                  </label>
                </div>
                <div class="house-kind input-wrap remove-error">
                  ...
                  <label class="image-wrap hand-navi-label" for="apartment">
                    <div class="normal sp"><%= image_tag asset_url("estimate_form/sp/off-btn-land.png") %></div>
                    <div class="invert sp"><%= image_tag asset_url("estimate_form/sp/on-btn-land.png") %></div>
                    <div class="normal pc"><%= image_tag asset_url("estimate_form/off-btn-land.png") %></div>
                    <div class="invert pc"><%= image_tag asset_url("estimate_form/on-btn-land.png") %></div>
                    <p>集合住宅オーナー</p>
                  </label>
                </div>
              </div>
            ...
            <div class="slide-navi">
              ...
              <div>
                <div class="step-next-btn" id="house_kind_btn">
                  <span>次へ</span>
                  <span class="next-arrow pc"><%= image_tag asset_url("estimate_form/next-arrow.png") %></span>
                  <span class="next-arrow sp"><%= image_tag asset_url("estimate_form/sp/next-arrow.png") %></span>
                </div>
              </div>
              <div class="next-btn-hand-navi<%= ' opacity-0' if !@lpgas_contact.house_kind.present? %>"><div><%= image_tag asset_url("estimate_form/hand-navi.png") %></div></div>
            </div>
          </div>
          <!-- SLIDE 1 END -->
              ...
              <div class="content-box sep-two step-hand-navi">
                ...
                <div class="house-kind input-wrap remove-error error-wrap">
                  ...
                  <label class="image-wrap hand-navi-label" for="change_contract">
                    <div class="normal sp"><%= image_tag asset_url("estimate_form/sp/off-btn-current.png") %></div>
                    <div class="invert sp"><%= image_tag asset_url("estimate_form/sp/on-btn-current.png") %></div>
                    <div class="normal pc"><%= image_tag asset_url("estimate_form/off-btn-current.png") %></div>
                    <div class="invert pc"><%= image_tag asset_url("estimate_form/on-btn-current.png") %></div>
                    <p>現在のお住まい</p>
                  </label>
                </div>
                <div class="house-kind input-wrap remove-error error-wrap">
                  ...
                  <label class="image-wrap hand-navi-label" for="new_contract">
                    <div class="normal sp"><%= image_tag asset_url("estimate_form/sp/off-btn-move.png") %></div>
                    <div class="invert sp"><%= image_tag asset_url("estimate_form/sp/on-btn-move.png") %></div>
                    <div class="normal pc"><%= image_tag asset_url("estimate_form/off-btn-move.png") %></div>
                    <div class="invert pc"><%= image_tag asset_url("estimate_form/on-btn-move.png") %></div>
                    <p>引越し先</p>
                  </label>
                </div>
              </div>
            ...
            <div class="slide-navi">
              <div>
                <div class="step-prev-btn" data-go-to-slide="0" data-cur-step="2">
                  ...
                  <span class="prev-arrow pc"><%= image_tag asset_url("estimate_form/prev-arrow.png") %></span>
                  <span class="prev-arrow sp"><%= image_tag asset_url("estimate_form/sp/prev-arrow.png") %></span>
                </div>
              </div>
              <div>
              ...
              <div class="next-btn-hand-navi<%= ' opacity-0' if !@lpgas_contact.estimate_kind.present? %>"><div><%= image_tag asset_url("estimate_form/hand-navi.png") %></div></div>
            </div>
          </div>
          <!-- SLIDE 2-1 END -->
          ...
          <div class="swiper-slide step6">
            ...
            <div class="slide-navi">
              ...
              <div class="next-btn-hand-navi"><div><%= image_tag asset_url("estimate_form/hand-navi.png") %></div></div>
            </div>
          </div>
          <!-- SLIDE 6 END -->
        </div>
  ...
  <div class="form-agreement invisible-slide">
    <p class="terms pc">当サービスをご利用頂くにあたり、 <%= link_to '「enepi」利用規約', from_kakaku? ? 'https://enepi.jp/agreement' : '/agreement', target: '_blank' %> に同意したものとみなします。</p>
    <p class="terms sp">当サービスをご利用頂くにあたり、<br><%= link_to '「enepi」利用規約', from_kakaku? ? 'https://enepi.jp/agreement' : '/agreement', target: '_blank' %> に同意したものとみなします。</p>
  </div>
</div>
