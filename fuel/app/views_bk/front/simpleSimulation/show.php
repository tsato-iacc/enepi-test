<% title "プロパンガス料金シミュレーション 結果" %>
<% description "プロパンガス料金のシミュレーション結果ページです。ご入力頂いた内容を元に、今のガス代がどれくらい安くなるか算出しています。ガスの見直しにお役立てください。" %>
...
<div class="article-page">
  ...
  　            <h4 class="current-price-title" style="margin: 0;float: left;">地域平均</h4>
          ...
          <% end %>
          <%= link_to Rails.application.config.form_path, class: "simulation-page-button", style: "height: auto;" do %>
  ...
  　        <%= render_chart(@chart, 'chart') %>
          ...
          <div class="simulation-image-background">
            <div class="simulation-sample-image">
              <%= image_tag "simulation1.png", :class => "simulation-img"%>
            </div>
          </div>
          ...
          <div class="simulation-image-background">
            <div class="simulation-sample-image">
              <%= image_tag "simulation2.png", :class => "simulation-img"%>
            </div>
          </div>
          <div class="simulation-sample-point-box">
          ...
          <div class="simulation-image-background">
            <div class="simulation-sample-image">
              <%= image_tag "simulation3.png", :class => "simulation-img"%>
            </div>
          </div>
          <%= link_to Rails.application.config.form_path, class: "simulation-page-button", style: "height: auto; margin-top: 60px;" do %>
            <div class="simulation-page-button-itself">
              <p style=" font-size: 150%;">Webで提案を見てみる→</p>
            </div>
          <% end %>
