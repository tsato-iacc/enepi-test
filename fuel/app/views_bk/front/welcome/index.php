...
<div class="panel" id="knowing_chooser">
  <div class="panel-inner">
    ...
    <div class="introduce_area">
      <%= link_to Rails.application.config.form_path, class: "btn orange-button service-detail", onclick: "ga('send', 'event', 'top-button', 'click', 'irai', 1);" do %>
      <div class="text-area">おトクなガス会社へ<br>無料切り替え依頼</div><%= image_tag asset_url("top/bt_bg_estimate.png") %><div class="arrow-area"></div><% end %>
    ...
    <div class="introduce_area">
      <%= link_to local_contents_path, class: "btn green-button service-detail", onclick: "ga('send', 'event', 'top-button', 'click', 'price-search', 1);" do %>
        <div class="text-area">都道府県別<br>ガス料金を検索</div><%= image_tag asset_url("top/br_bg_search.png") %><div class="arrow-area"></div>
      <% end %>
...
<div class="panel" id="merit">
  <div class="panel-inner">
    ...
    <ul>
      <li>
        <%= image_tag asset_url("top/ico_merit1.png") %>
        <h3>切替手続き無料</h3>
        <p>お見積もり依頼からガス会社の切り替えまで費用は一切かかりません。</p>
      </li>
      <li>
        <%= image_tag asset_url("top/ico_merit2.png") %>
        <h3>解約手続き不要</h3>
        <p>お客様からガス会社への解約手続きのご連絡は不要です。※一部地域を除く</p>
      </li>
      <li>
        <%= image_tag asset_url("top/ico_merit3.png") %>
        <h3>仲介手数料無料</h3>
        <p>新しいガス会社へ切り替えをされても仲介手数料などは一切いただきません。</p>
      </li>
      <li>
        <%= image_tag asset_url("top/ico_merit4.png") %>
        <h3>エネピ紹介特典あり</h3>
  ...
  <div class="panel-inner">
    ...
    <div class="category-ttl-area">
      ...
      <ul class="article-list-menu">
        <li><%= link_to 'コラム',  "/categories/lpgas/column" %></li>
        <li><%= link_to '節約術', "/categories/lpgas/saving" %></li>
        <li><%= link_to '会社一覧', "/categories/lpgas/company_list" %></li>
        <li><%= link_to '基礎知識', "/categories/lpgas/knowledge" %></li>
        <li><%= link_to '見積もりのコツ', "/categories/lpgas/estimate" %></li>
        <li><%= link_to 'すべての記事', articles_path %></li>
      </ul>
    </div>
    ...
    <ul>
      ...
      <%= image_tag asset_url("top/ico_article_01.png") %><p>プロパンガスの<br>コラム</p></li></a>
      <a href="/categories/lpgas/saving"><li class="curled-box"><i></i>
      <%= image_tag asset_url("top/ico_article_02.png") %><p>プロパンガス<br>節約術</p></li></a>
      <a href="/categories/lpgas/company_list"><li class="curled-box"><i></i>
      <%= image_tag asset_url("top/ico_article_03.png") %><p>プロパンガス<br>会社一覧</p></li></a>
    </ul>

    <ul class="lower">
      <a href="/categories/lpgas/knowledge"><li class="curled-box"><i></i>
      <%= image_tag asset_url("top/ico_article_04.png") %><p>基礎<br>知識</p></li></a>
      <a href="/categories/lpgas/estimate"><li class="curled-box"><i></i>
      <%= image_tag asset_url("top/ico_article_05.png") %><p>見積もりの<br>コツ</p></li></a>
      <a href="/categories/lpgas/"><li class="curled-box"><i></i>
      <%= image_tag asset_url("top/ico_article_06.png") %><p>すべての<br>記事</p></li></a>
    </ul>
  </div>
</div>
...
<div class="panel" id="reason">
  ...
  <div class="blue-color center">＼なぜプロパンガス会社を切り替えるといいの？／</div>
    <h2>
    <span class="blue-color">「知らない」</span>方は<br><%= image_tag asset_url("top/img_otoku.png"), :class => 'goodbuy-img' %>になれる<span class="blue-color">3つの理由</span>をご紹介！</h2>

    <h3><%= image_tag asset_url("top/ttl_goodvalue-reason1.png"), :alt => 'おトクになれる3つの理由1' %></h3>
    <div class="inner-area">
      <p class="lead">適正なガス料金で提供してもらえる！</p>

    <div class="example-contents">
      <div class="box margin">
        <%= image_tag asset_url("top/img_reason1-1.png") %>
        <h4>例えば「水」の場合…
      ...
      <div class="arrow1"><%= image_tag asset_url("top/ico-reason-arrow.png") %></div>

      <div class="box margin">
        <h4>ガスの質と量はまったく同じ！</h4>
        <%= image_tag asset_url("top/img_reason1-2.png") %>
        <p>毎月の請求するガス料金の決め方は様々ですが、一番多い請求方法は、「基本料金」と「ガスの使用量」の合計金額です。このガス使用量の1㎥に当たる単価が業者によって異なる場合が多く、毎月の請求額に差が出てきます。</p>
      </div>

      <div class="arrow2"><%= image_tag asset_url("top/ico-reason-arrow.png") %></div>

      <div class="box">
        <h4>ひと月にほぼ同じ量のガスを使用したとして</h4>
        <%= image_tag asset_url("top/img_reason1-3.png") %>
      ...
      <div class="danger-list-box">
        <div class="inner">
          <%= image_tag asset_url("top/ico-danger.png") %>
            <ul>
    ...
    <h3><%= image_tag asset_url("top/ttl_goodvalue-reason2.png"), :alt => 'おトクになれる3つの理由2' %></h3>
    ...
    <div class="inner-area margin">
      ...
      <div class="example-contents">
        <div class="box margin">
          <h4>例えばこんな場合...</h4>
          <%= image_tag asset_url("top/img_reason2-1.png") %>
        ...
        <div class="box margin">
          ...
          <%= image_tag asset_url("top/img_reason2-2_1.png") %>
          <h4>管理体制が無いガス会社の場合</h4>
          <%= image_tag asset_url("top/img_reason2-2_2.png") %>
        ...
        <div class="box">
          ...
          <%= image_tag asset_url("top/img_reason2-3.png") %>
    ...
    <h3><%= image_tag asset_url("top/ttl_goodvalue-reason3.png"), :alt => 'おトクになれる3つの理由3' %></h3>
    ...
    <div class="inner-area margin">
      ...
      <div class="example-contents">
        <div class="box margin">
          <%= image_tag asset_url("top/img_reason3-1.png") %>
        ...
        <div class="box margin">
          ...
          <%= image_tag asset_url("top/img_reason3-2_1.png") %>
          <h4>サービスが充実していない会社の場合</h4>
          <%= image_tag asset_url("top/img_reason3-2_2.png") %>
        ...
        <div class="box">
          ...
          <%= image_tag asset_url("top/img_reason3-3.png") %>
    ...
    <div class="hidden_sp">
      <dl class="case-area-sp">
        ...
        <dd class="contents_case_two">
          <%= image_tag asset_url("top/img_case2.png") %>
          <%= image_tag asset_url("top/img_price-compare-2.png") %>

          <p class="benefit-txt">1ヶ月だと<span class="amount">3,600円</span>おトクに！<br>1年間では<span class="yearly-amount">43,200円</span>おトクに！</p>

          <%= link_to new_simple_simulation_path, class: "simulation-button with-arrow-right-icon" do %>
            <div class="text">
      ...
      <dl class="case-area-sp">
        ...
        <dd class="contents_case_four">
          <%= image_tag asset_url("top/img_case4.png") %>
          <%= image_tag asset_url("top/img_price-compare-4.png") %>
      ...
      <dl class="case-area-sp">
        ...
        <dd class="contents_case_six">
          <%= image_tag asset_url("top/img_case6.png") %>
          <%= image_tag asset_url("top/img_price-compare-6.png") %>
...
<div class="panel" id="secure-reason">
  <div class="panel-inner">
    ...
    <ul>
      <li>
        <%= image_tag asset_url("top/ico_reason1.png") %>
        <p>これまでのガス代よりも<br>おトクになれる業者を<br>ご紹介します。</p>
      </li>
      <li>
        <%= image_tag asset_url("top/ico_reason2.png") %>
        <p>しっかりした対応を<br>してくれる業者のみの<br>ご紹介が出来ます。</p>
      </li>
      <li>
        <%= image_tag asset_url("top/ico_reason3.png") %>
    ...
    <div class="hidden_pc">
      <div class="flow-box">
        <div class="flow1">
          ...
          <%= image_tag asset_url("top/img_arrow_flow_right.png"), :class => 'icon-right' %>
        <div class="flow2">
        ...
        <!--<%= image_tag asset_url("top/img_arrow_flow_under.png") %>-->
      </div>
      <div class="flow-box">
        <div class="flow6">
          <p>点火テスト後、これまで通り<br>ガスの利用が可能に！</p>
        </div>
        <%= image_tag asset_url("top/img_arrow_flow_left.png"), :class => 'icon-left' %>
        <div class="flow5">
    ...
    <div class="hidden_sp">
      <div class="flow-box">
        <div class="flow1">
          ...
          <%= image_tag asset_url("top/img_arrow_flow_under.png"), :class => 'icon-bottom' %>
        <div class="flow2">
...
<div class="panel" id="qa">
  <div class="panel-inner">
    <h2>プロパンガスにまつわる<%= image_tag asset_url("top/ico_q.png"), :class => 'q-circle', :alt => 'Q' %>&<%= image_tag asset_url("top/ico_a.png"), :class => 'a-circle', :alt => 'A' %></h2>
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>プロパンガスとLPガスは同じガスなの？</h3>
          <p class="accordion_icon active">
            <span></span><span></span>
          </p>
        </dt>
        <dd style="display: block;">
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>同じガスです。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>都市ガスとプロパンガスは違うガスなの？</h3>
          <p class="accordion_icon active">
            <span></span><span></span>
          </p>
        </dt>
        <dd style="display: block;">
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>違うガスです。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>LPガスは、電気代や都市ガスのような公共料金ではないの？</h3>
          <p class="accordion_icon active">
            <span></span><span></span>
          </p>
        </dt>
        <dd style="display: block;">
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>公共料金ではありません。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>うちのガス料金って高いと思うけど、相場はいくらくらいなの？</h3>
          <p class="accordion_icon">
            <span></span><span></span>
          </p>
        </dt>
        <dd>
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>地域や使用量によって異なります。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>他の業者さんに変えると料金は安くなるの？？</h3>
          <p class="accordion_icon">
            <span></span><span></span>
          </p>
        </dt>
        <dd>
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>安くなる可能性が高いです。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>今の業者さんに価格交渉して安くしてもらってはダメなの？</h3>
          <p class="accordion_icon">
            <span></span><span></span>
          </p>
        </dt>
        <dd>
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>信頼できるガス会社かどうか、見極めが必要です。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>集合住宅に住んでいる場合も簡単に変更できるの？</h3>
          <p class="accordion_icon">
            <span></span><span></span>
          </p>
        </dt>
        <dd>
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>大家さんの了承が必要です。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>ガス会社を変更すると設備の変更などは必要なの？</h3>
          <p class="accordion_icon">
            <span></span><span></span>
          </p>
        </dt>
        <dd>
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>ガスボンベとメーターのみ変更します。</h4>
    ...
    <div id="accordion" class="accordionbox">
      <dl class="accordionlist">
        <dt class="clearfix">
          <h3 class="title"><i><%= image_tag asset_url("top/ico_q.png") %></i>都市ガスは切り替えすることができるの？</h3>
          <p class="accordion_icon">
            <span></span><span></span>
          </p>
        </dt>
        <dd>
          <h4><i><%= image_tag asset_url("top/ico_a.png") %></i>2017年4月より切り替えが可能になります。</h4>
  ...
  <div class="panel-inner">
    ...
    <div class="hidden_sp">
      <div class="cta-area-sp">
        <h2>プロパンガス会社の見直しでもっと<%= image_tag asset_url("top/img_otoku.png"), :class => 'goodbuy-img' %>になる！</h2>
        <%= image_tag asset_url("top/img-cta-balloon.png"), :class => 'goodbuy-img', :alt => 'まずはエネピに相談！'  %>
        <%= link_to Rails.application.config.form_path, class: "ctaarea-button with-arrow-right-icon btn-inner" do %>
    ...
    <div class="hidden_pc">
      <div class="cta-area">
        <%= link_to Rails.application.config.form_path, class: "ctaarea-button with-arrow-right-icon btn-inner", onclick: "ga('send', 'event', 'estimate-button', 'click', 'top3', 1);" do %>
            <span class="free-txt">無料</span>
            <div class="text">
              <span class="main">プロパンガス代が<br>安くなるか確かめる！</span>
            </div>
