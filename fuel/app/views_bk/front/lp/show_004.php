...
<head>
  ...
  <% description 'エネピならプロパンガス料金を複数社から「比較」して、1番おトクなガス会社へ乗り換えられます！年間で最大8万円も安くなることも。ガス代やガス会社にお悩みの方はまずはこちらのフォームから完全無料でご利用頂けます。' %>
  ...
  <div class="lp004-header-wrap">
    <div class="guide-header">
      <div class="lp004-logobox">
        <a class="lp004-logo-img"><%= image_tag asset_url("logo-v2.png"), :class=>"lp004-logo" %></a>
      </div>
      <div class="lp004-telbox">
        <% if smart_phone? %>
          <a href="tel:0120771664" class="lp004-tel-img"><%= image_tag "estimate_presentation/img_tel.png", :class => 'tel' %></a>
        <% else %>
          <a class="lp004-tel-img"><%= image_tag "estimate_presentation/img_tel.png", :class => 'tel' %></a>
        <% end %>
      </div>
    </div>
  </div>
