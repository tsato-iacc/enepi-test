<% title "全国のプロパンガス(LPガス)の平均利用額はココでチェック!" %>
<% description "全国のプロパンガス料金を知りたい方はこちらをチェック！お住まいの地域をクリックして頂くと、市区町村ごとの詳細なガス代を調べられます。プロパンガス(LPガス)は地域によって料金が異なるので、平均的なガス代を把握し、見直しに役立ててください。" %>
          ...
          <div class="japan-map">
            ...
            <%else%>
              ...
              <div class="japan-map-background">
                <%= image_tag "japan-map.png", :class => "japan-map-img"%>
