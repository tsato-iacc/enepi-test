...
<a class="btn btn-secondary mb-4" href="<?= \Uri::create('partner/estimates/:uuid.pdf'.'?'.http_build_query(['u' => $auth_user->id]), ['uuid' => $estimate->uuid]); ?>" role="button">現地調査表(pdf)出力</a>
