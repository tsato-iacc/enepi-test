<div class="btn-group" role="group">
  <?= MyView::link_to(fa_text('list', '見積もり依頼一覧'), admin_lpgas_company_estimates_path(@company), ["class" => 'btn btn-default' ?>
  <?= MyView::link_to(fa_text('exclamation-triangle', 'NG企業'), admin_lpgas_company_ng_companies_path(@company), ["class" => 'btn btn-default' ?>
  <?= MyView::link_to(fa_text('map-marker', '営業拠点一覧'), admin_lpgas_company_offices_path(@company), ["class" => 'btn btn-default' ?>
  <?= MyView::link_to(fa_text('edit', '編集'), edit_admin_lpgas_company_path(@company), ["class" => 'btn btn-default' ?>
</div>
...
<?= simple_form_for [:admin, @company] { |f| ?>
