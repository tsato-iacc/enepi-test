...
<table class="table table-striped table-hover" style="margin-bottom: 0">
  ...
  <tbody>
    <% [true, false].each do |using_cooking_stove| %>
      <% [true, false].each do |using_bath_heater_with_gas_hot_water_supply| %>
        <% [true, false].each do |using_other_gas_machine| %>
          <% Lpgas::PriceRule.house_kinds.keys.each do |house_kind| %>
            ...
            <tr>
              ...
              <%= link_to '削除', admin_lpgas_company_company_geocode_price_rule_path(
