<table class="table table-condensed table-striped table-hover">
  ...
  <tr>
    <th>問い合わせID</th>
    <td><%= link_to @estimate.contact_id, admin_lpgas_contact_path(@estimate.contact_id) %></td>
  </tr>
  <tr>
    <th>有効期限</th>
    <td>
  ...
  <tr>
    <th>紹介した会社</th>
    <td><%= link_to @estimate.company.full_name, admin_lpgas_company_path(@estimate.company) %></td>
  </tr>
  <tr>
    <th>ステータス</th>
  ...
  <tr>
    ...
    <td>
      ...
      <% else %>
        <ul>
          <% @estimate.unit_prices.each do |u| %>
            <li>
