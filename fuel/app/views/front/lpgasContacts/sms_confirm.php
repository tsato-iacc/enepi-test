        ...
        <div class="estimate">
          <div class="container">
            ...
            <div class="container pc">
              <?if($contact->status == $contact->getStatusColor()){ ?>
              ...
              <div>
                <div class="text-center">
                  <?= Form::open(['action' => \Uri::create('/lpgas/contacts/'.$contact->id), 'accept-charset' => 'UTF-8', 'method' => 'GET']); ?>
                    <?= Form::hidden('utf8', '&#x2713;'); ?>
                    <?= Form::hidden('token', $contact->token, ['id' => 'token']); ?>
    ...
    <noscript>
      <div style="display: inline;">
        <img height="1" width="1" style="border-style: none;" alt=""
          src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/835778474/?guid=ON&amp;script=0" />
      </div>
    </noscript>
    <!-- YDN END -->
