                  ...
                  <div class="company-name-ttl">
                    <div class="checkbox-big-sp">
                      <?if($e->status ==\Config::get('models.estimate.status.sent_estimate_to_user')){ ?>
                        <input type="checkbox" name="estimates[]" value="<?= $e->id; ?>" id="estimate_ids_<?= $count ?>">
                      <? } ?>
                ...
                <div class="inner">
                  <div style="clear:both;">
                    <div class="company-logo">
                      <?= S3::image_tag_s3(S3::makeImageUrl($e->company), ["class" => "media-object", "alt" => mb_substr($e->company->lpgas_company_logo, 0, mb_strpos($e->company->lpgas_company_logo, "."))]); ?>
                    </div>
