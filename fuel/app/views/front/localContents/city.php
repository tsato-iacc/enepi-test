<% title "【#{@prefecture_itself.name}#{@city_itself.city_name}】プロパンガス(LPガス)料金の適正価格と相場！" %>
<% description "#{@prefecture_itself.name}#{@city_itself.city_name}のプロパンガス料金を知りたい方はこちらをチェック！お住まいの地域ごとに平均的なガス代を調べられます。プロパンガス(LPガス)は地域によって料金が異なるので、平均的なガス代を把握し、見直しに役立ててください。" %>
