            ...
            <div class="average-rate-box-content">
              <div class="average-rate-box-basic">
                <dl>
                  <dt class="average-rate-box-data-title">基本料金</dt>
                   <? if($city_data->basic_rate != 0){ ?>
                    <dd class="average-rate-box-data-detail"><?= number_format($city_data->basic_rate); ?>円</dd>
                  <? }else{ ?>
              ...
              <div class="average-rate-box-basic">
                <dl>
                  ...
                  <? if($city_data->commodity_charge != 0){ ?>
                    <dd class="average-rate-box-data-detail"><?= number_format($city_data->commodity_charge); ?>円</dd>
                  <? }elseif($prefecture_data->commodity_charge_criterion != 0){ ?>
            ...
            <div class="average-usage-box-circle">
              <div class="average-usage-box-data">
                <? if($city_data->average_usage != 0){ ?>
                  <?= number_format($city_data->average_usage, 1); ?>㎥
                <? }else{ ?>
                  -
                <? } ?>
              </div>
          ...
          <div class="average-rate-list-box">
            ...
            <table summary="<?= $city_name ?>の使用量別1ヶ月の平均プロパンガス料金" border width="80%" height="200" cellspacing="0" cellpadding="0" style="margin: auto;">
              ...
              <tr align="center">
                ...
                <? if($city_data->five_cubic_meters_price != 0){ ?>
                  <td class="usage-breakdown-data"><?= number_format($city_data->five_cubic_meters_price) ?>円/月</td>
                <?}elseif($prefecture_data->five_cubic_meters_price != 0){ ?>
              ...
              <tr align="center">
                ...
                <? if($city_data->ten_cubic_meters_price != 0){ ?>
                  <td class="usage-breakdown-data"><?= number_format($city_data->ten_cubic_meters_price) ?>円/月</td>
                <?}elseif($prefecture_data->ten_cubic_meters_price != 0){ ?>
              ...
              <tr align="center">
                ...
                <? if($city_data->twenty_cubic_meters_price != 0){ ?>
                  <td class="usage-breakdown-data"><?= number_format($city_data->twenty_cubic_meters_price) ?>円/月</td>
                <?}elseif($prefecture_data->twenty_cubic_meters_price != 0){ ?>
              ...
              <tr align="center">
                ...
                <? if($city_data->fifty_cubic_meters_price != 0){ ?>
                  <td class="usage-breakdown-data"><?= number_format($city_data->fifty_cubic_meters_price) ?>円/月</td>
                <?}elseif($prefecture_data->fifty_cubic_meters_price != 0){ ?>
