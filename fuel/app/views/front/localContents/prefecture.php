        ...
        <div class="local-content-middle">
          ...
          <div class="local-content-preface">
            <p class="local-content-middle-intro">
              <?= @prefecture_itself.name ?>でプロパンガスをご利用になられている方はこちらのページをご覧ください。<br><? if @prefecture.number_of_approved_company != 0 ?> ゴールド保安認定事業者(第一号認定LPガス販売事業者)に認定されている<?= @prefecture_itself.name ?>のプロパンガス会社は<?= @prefecture.number_of_approved_company ?>社います。<br><? } ?>金額の見直しを検討される方はプロパンガス会社の無料お見積もり依頼をお試しください!<br>ページ下のボタンをクリックし、フォームに必要な情報を入力して頂くと、エネピに加盟している厳選ガス会社をご紹介致します。
            </p>
