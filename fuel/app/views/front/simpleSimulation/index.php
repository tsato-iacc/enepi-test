<% title "簡単入力！プロパンガス料金シミュレーション" %>
<% description "プロパンガス料金シミュレーションは、使用量やガス料金などを入力するだけで切り替え後の料金イメージをラクラク算出できます！さらにガス代が高くてお悩みのお客様には今よりおトクになるガス会社をネット上で無料ご提案します。" %>
<%- if flash[:notice] %>
          ...
          <%= form_tag(simple_simulations_path, method: 'POST') do %>
            ...
            <div class="simulation-extra-info">
              ...
              <select name="household" class="household-selector">
                <% if @data.present? %>
                  <% if @data.household == "two_or_less_person_household" %>
                  ...
                  <% elsif @data.household == "three_person_household" %>
                    <option value="two_or_less_person_household" >2人以下</option>
                    <option value="three_person_household" selected >3人</option>
                    <option value="four_person_household">4人</option>
                    <option value="five_person_household">5人</option>
                    <option value="six_person_household">6人</option>
                    <option value="seven_or_more_person_household">7人以上</option>
                  <% elsif @data.household == "four_person_household" %>
                    <option value="two_or_less_person_household" >2人以下</option>
                    <option value="three_person_household">3人</option>
                    <option value="four_person_household" selected >4人</option>
                    <option value="five_person_household">5人</option>
                    <option value="six_person_household">6人</option>
                    <option value="seven_or_more_person_household">7人以上</option>
                  <% elsif @data.household == "five_person_household" %>
                    <option value="two_or_less_person_household" >2人以下</option>
                    <option value="three_person_household">3人</option>
                    <option value="four_person_household">4人</option>
                    <option value="five_person_household" selected >5人</option>
                    <option value="six_person_household">6人</option>
                    <option value="seven_or_more_person_household">7人以上</option>
                  <% elsif @data.household == "six_person_household" %>
                    <option value="two_or_less_person_household" >2人以下</option>
                    <option value="three_person_household">3人</option>
                    <option value="four_person_household">4人</option>
                    <option value="five_person_household">5人</option>
                    <option value="six_person_household" selected >6人</option>
                    <option value="seven_or_more_person_household">7人以上</option>
                  <% elsif @data.household == "seven_or_more_person_household" %>
                    <option value="two_or_less_person_household" >2人以下</option>
                    <option value="three_person_household">3人</option>
                    <option value="four_person_household">4人</option>
                    <option value="five_person_household">5人</option>
                    <option value="six_person_household">6人</option>
                    <option value="seven_or_more_person_household" selected >7人以上</option>
                  <% end %>
                <% else %>
                  <option value="two_or_less_person_household" selected >2人以下</option>
                  <option value="three_person_household">3人</option>
